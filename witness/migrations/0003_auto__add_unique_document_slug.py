...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('witness_document', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Document', fields ['slug']
        db.delete_unique('witness_document', ['slug'])
    ...
    models = {
        ...
        'witness.documentversion': {
            ...
            'last_update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'no_action_text': ('django.db.models.fields.CharField', [], {'default': "'I disagree'", 'max_length': '64'}),
            'number': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'yes_action_text': ('django.db.models.fields.CharField', [], {'default': "'I agree'", 'max_length': '64'})
        }
    }
