...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Decision.address'
        db.alter_column('witness_decision', 'address', self.gf('django.db.models.fields.CharField')(default=None, max_length=64))
    ...
    models = {
        ...
        'witness.decision': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '64', 'null': 'True'}),
