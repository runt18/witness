...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentVersion.require_address'
        db.add_column('witness_documentversion', 'require_address',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Decision.address'
        db.add_column('witness_decision', 'address',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentVersion.require_address'
        db.delete_column('witness_documentversion', 'require_address')

        # Deleting field 'Decision.address'
        db.delete_column('witness_decision', 'address')
    ...
    models = {
        ...
        'witness.decision': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '64'}),
